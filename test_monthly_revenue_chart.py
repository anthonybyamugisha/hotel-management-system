...
def test_monthly_revenue_chart():
    """Test the monthly revenue chart data fetching"""
    
    # Import the execute_sql function
    from reports.views import execute_sql
    
    try:
        print("Testing monthly revenue chart data fetching...")
...
if __name__ == "__main__":
    success = test_monthly_revenue_chart()
    if success:
        print("\n✅ Monthly revenue chart test completed successfully!")
    else:
        print("\n❌ Monthly revenue chart test failed!")