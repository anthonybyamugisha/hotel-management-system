...
def test_occupancy_report():
    """Test the room occupancy report data fetching"""
    
    # Import the execute_sql function
    from reports.views import execute_sql
    
    try:
        print("Testing room occupancy report data fetching...")
...
if __name__ == "__main__":
    success = test_occupancy_report()
    if success:
        print("\n✅ Room occupancy report test completed successfully!")
    else:
        print("\n❌ Room occupancy report test failed!")