...
def test_staff_performance():
    """Test the staff performance report data fetching"""
    
    # Import the execute_sql function
    from reports.views import execute_sql
    
    try:
        print("Testing staff performance report data fetching...")
...
if __name__ == "__main__":
    success = test_staff_performance()
    if success:
        print("\n✅ Staff performance report test completed successfully!")
    else:
        print("\n❌ Staff performance report test failed!")